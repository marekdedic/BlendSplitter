...
Definition at line 25 of file Blend\+Splitter.\+hpp.
...
\index{Blend\+Splitter@{Blend\+Splitter}!Blend\+Splitter@{Blend\+Splitter}}
\subsubsection[{\texorpdfstring{Blend\+Splitter(\+Q\+Widget $\ast$($\ast$default\+Widget)()=[]() -\/$>$\+Q\+Widget $\ast$\lcurly{}return new Switching\+Widget\lcurly{}\rcurly{};\rcurly{}, Qt\+::\+Orientation orientation=\+Qt\+::\+Horizontal)}{BlendSplitter(QWidget *(*defaultWidget)()=[]() ->QWidget *\{return new SwitchingWidget\{\};\}, Qt::Orientation orientation=Qt::Horizontal)}}]{\setlength{\rightskip}{0pt plus 5cm}Blend\+Splitter\+::\+Blend\+Splitter (
\begin{DoxyParamCaption}
\item[{Q\+Widget $\ast$($\ast$)()}]{default\+Widget = {\ttfamily \mbox{[}\mbox{]}()~-\/$>$QWidget~$\ast$\{return~new~{\bf Switching\+Widget}\{\};\}}, }
\item[{Qt\+::\+Orientation}]{orientation = {\ttfamily Qt\+:\+:Horizontal}}
...
\subsubsection[{\texorpdfstring{add\+Splitter(\+Blend\+Splitter $\ast$splitter)}{addSplitter(BlendSplitter *splitter)}}]{\setlength{\rightskip}{0pt plus 5cm}void Blend\+Splitter\+::add\+Splitter (
\begin{DoxyParamCaption}
\item[{{\bf Blend\+Splitter} $\ast$}]{splitter}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{add\+Widget()}{addWidget()}}]{\setlength{\rightskip}{0pt plus 5cm}void Blend\+Splitter\+::add\+Widget (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
Adds the default widget to the very bottom/right of the \hyperlink{class_blend_splitter}{Blend\+Splitter}. \index{Blend\+Splitter@{Blend\+Splitter}!add\+Widget@{add\+Widget}}
\index{add\+Widget@{add\+Widget}!Blend\+Splitter@{Blend\+Splitter}}
\subsubsection[{\texorpdfstring{add\+Widget(\+Q\+Widget $\ast$widget)}{addWidget(QWidget *widget)}}]{\setlength{\rightskip}{0pt plus 5cm}void Blend\+Splitter\+::add\+Widget (
\begin{DoxyParamCaption}
\item[{Q\+Widget $\ast$}]{widget}
\end{DoxyParamCaption}
)}\hypertarget{class_blend_splitter_a305c3aee946a9fb9dcd95fdc72faff8b}{}\label{class_blend_splitter_a305c3aee946a9fb9dcd95fdc72faff8b}
...
\subsubsection[{\texorpdfstring{insert\+Splitter(int index, Blend\+Splitter $\ast$splitter)}{insertSplitter(int index, BlendSplitter *splitter)}}]{\setlength{\rightskip}{0pt plus 5cm}void Blend\+Splitter\+::insert\+Splitter (
\begin{DoxyParamCaption}
\item[{int}]{index, }
\item[{{\bf Blend\+Splitter} $\ast$}]{splitter}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{insert\+Widget(int index)}{insertWidget(int index)}}]{\setlength{\rightskip}{0pt plus 5cm}void Blend\+Splitter\+::insert\+Widget (
\begin{DoxyParamCaption}
\item[{int}]{index}
\end{DoxyParamCaption}
...
\index{Blend\+Splitter@{Blend\+Splitter}!insert\+Widget@{insert\+Widget}}
\index{insert\+Widget@{insert\+Widget}!Blend\+Splitter@{Blend\+Splitter}}
\subsubsection[{\texorpdfstring{insert\+Widget(int index, Q\+Widget $\ast$widget)}{insertWidget(int index, QWidget *widget)}}]{\setlength{\rightskip}{0pt plus 5cm}void Blend\+Splitter\+::insert\+Widget (
\begin{DoxyParamCaption}
\item[{int}]{index, }
\item[{Q\+Widget $\ast$}]{widget}
\end{DoxyParamCaption}
